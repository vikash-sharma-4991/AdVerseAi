    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Designed for Modern Marketing"
                    description="Turn your products and model photos into scroll-stopping ads built for Reels, Shorts, and modern marketing campaigns."
                />
